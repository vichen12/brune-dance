...
export function Contact() {
  ...
  const CLASS_OPTIONS = [
    ...
    "Pilates Mat",
    "Ballet",
    t("contact_online_class") as string,
  ];
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
        ...
        >
          ...
          <div className="lg:hidden text-center mb-10">
            <p className="font-lato text-[0.62rem] font-bold tracking-[.35em] uppercase mb-3"
               style={{ color: "var(--color-gold)" }}>
              {t("contact_title") as string}
            </p>
            <h2
            ...
            <p className="font-playfair italic text-lg mt-4" style={{ color: "var(--color-primary)" }}>
              {t("contact_tagline") as string}
            </p>
          </div>
